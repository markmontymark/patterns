...
ChaiDecorator
  ...
  describe 'Test Structural Decorator', ->
    it 'Can we brew some chai?', ->
      ...
      expect(chaiDecorator.steepTea()).toEqual("bay leaf is steeping ,cinnamon stick is steeping ,ginger is steeping ,honey is steeping ,soy milk is steeping ,vanilla bean is steeping , tea is steeping with chai")
