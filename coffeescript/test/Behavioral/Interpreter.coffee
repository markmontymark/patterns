define ['Behavioral/Interpreter/DvdInterpreterContext',
'Behavioral/Interpreter/TitleAndActor',
'Behavioral/Interpreter/DvdInterpreterClient'
],(
...
DvdInterpreterClient
	...
	describe '',->
		it '',->
			...
			expect( "interpreting show title for actor : " + dvdInterpreterClient.interpret( "show title for actor ")).toEqual( 'interpreting show title for actor : Query Result: ,')
