...
- Command and Query Responsibility Segregation (CQRS) Pattern, descriptions [here](https://msdn.microsoft.com/en-us/library/dn568103.aspx) and [here](https://www.martinfowler.com/bliki/CQRS.html)
